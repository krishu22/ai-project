...
import TfAnswer from '../components/quiz/TfAnswer'

const DisplayTfAnswerPage = ({tfAnswers, questions}) => {

        console.log("Display answer page props : ", tfAnswers);
                        ...
                        <div>
                                {questions.map((question, index) => (
                                        <TfAnswer
                                                ...
                                                userAnswer={tfAnswers[index]} // string
...
export default DisplayTfAnswerPage
